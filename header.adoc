...
The QoS identifiers extension, introduces a read/write M-mode register
- `mqoscfg` - to configure QoS Identifiers - `RCID` and `MCID` - to be used
with requests made by the hart when in M-mode.
